...
namespace EvRoutePlanner.Api.Controllers
{
    ...
    public class VehicleController : ControllerBase
    {
        ...
        public VehicleController(IVehicleService vehicleService, IRangeService rangeService, IFuelEconomyService fuelEconomyService)
        {
        ...
        //    double remainingRange = _rangeService.CalculateRemainingRange(vehicle.BatteryCapacity, vehicle.CurrentSoc);
